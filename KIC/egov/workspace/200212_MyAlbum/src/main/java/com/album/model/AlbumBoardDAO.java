...
public class AlbumBoardDAO
{
	...
	private String uploadPath = "C:/MyCloud/OneDrive/eGovFrameDev-3.8.0-64bit/workspace/200212_MyAlbum/src/main/webapp/upload/";
	...
	public AlbumBoardListTO boardList(AlbumBoardListTO listTO)
	{
		...
		try {
			...
			ArrayList<AlbumBoardTO> boardLists = new ArrayList<AlbumBoardTO>();
