...
<%
	...
	ArrayList<AlbumCommentTO> commentList = (ArrayList<AlbumCommentTO>) request.getAttribute( "commentList" );

	StringBuffer sbCommentHtml = new StringBuffer();

	
	
	for (int i = 0; isLogin && i < commentList.size(); ++i) {
		...
		sbCommentHtml.append("<form action='./comment_delete_ok.do' method='post' name='ccfrm' ");
	...
	<div class="contents1">
		...
		<div class="contents_sub">
			...
			<div class="board_view">
				...
				<c:if test="${ sessionScope.album_isLogin }">
					...
					<table>
						<tr>
							<td width="94%" class="coment_re">글쓴이 <input type="text"
								name="cwriter" value="${ sessionScope.album_loginUser.name }" maxlength="5" class="coment_input" readonly="readonly"/>&nbsp;&nbsp;
