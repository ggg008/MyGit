...
<%
	...
	String mailObj = userObj != null ? ((AlbumMemberTO) userObj).getMail() : null; 
				...
				<div class="board_write">
					<table>
						<tr>
							...
							<c:if test="${ sessionScope.album_isLogin == true }">
							<td class="top" colspan="3"><input type="text" name="writer"
								value="${ sessionScope.album_loginUser.name }" class="board_view_input_mail" maxlength="5" readonly="readonly" /></td>
							</c:if>
							<c:if test="${ sessionScope.album_isLogin == false }">
							<td class="top" colspan="3"><input type="text" name="writer"
						...
						<tr>
							...
							<td colspan="3"><input type="file" name="upload" value=""
								class="board_view_input" accept=".gif, .jpg, .png" /></td>
						</tr>
						<tr>
							<th>이메일</th>
							...
							<c:if test="${ sessionScope.album_isLogin == true }">		
							<td colspan="3"><input type="text" name="mail1" value="<%= userMail1 %>"
								class="board_view_input_mail" readonly="readonly" /> @ <input type="text"
								name="mail2" value="<%= userMail2 %>" class="board_view_input_mail" readonly="readonly" /></td>
							</c:if>
