...
<div class="contents1"> 
	...
	<form action="./member_write1_ok.do" method="post" name="frm" onsubmit="return frmsubmit()">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th>이름</th>
					<td colspan="3"><input type="text" id="input_writer" name="writer" value="" class="board_write_input"/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
				...
				<tr>
					<th>이메일</th>
					<td colspan="3"><input type="text" id="input_mail1" name="mail1" value="" class="board_write_input_100" /> @ <input type="text" name="mail2" value="" class="board_write_input_100"  /></td>
				</tr>
				</table>
