...
<div class="contents1"> 
	...
	<form action="board_modify1_ok.do" method="post" name="boardfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			...
			<div class="btn_area">
				<div class="align_left">			
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='board_view1.do?cpage=<%=cpage %>&seq=<%=seq %>'" />
				</div>
