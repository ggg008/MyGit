public class JuminCheckEx02 {
	...
	public static void main(String[] args) {
		 ...
		 * int i2 = Integer.parseInt(strJumin.substring(1, 2)) * 3; // 1~2전 번째 숫자 추출 int
		 * i3 = Integer.parseInt(strJumin.substring(2, 3)) * 4; int i4 =
		 * Integer.parseInt(strJumin.substring(3, 4)) * 5; int i5 =
		 * Integer.parseInt(strJumin.substring(4, 5)) * 6; int i6 =
		 * Integer.parseInt(strJumin.substring(5, 6)) * 7; int i7 =
		 * Integer.parseInt(strJumin.substring(6, 7)) * 8; int i8 =
		 * Integer.parseInt(strJumin.substring(7, 8)) * 9; int i9 =
		 * Integer.parseInt(strJumin.substring(8, 9)) * 2; int i10 =
		 * Integer.parseInt(strJumin.substring(9, 10)) * 3; int i11 =
		 * Integer.parseInt(strJumin.substring(10, 11)) * 4; int i12 =
		 * Integer.parseInt(strJumin.substring(11, 12)) * 5;
		 * 
