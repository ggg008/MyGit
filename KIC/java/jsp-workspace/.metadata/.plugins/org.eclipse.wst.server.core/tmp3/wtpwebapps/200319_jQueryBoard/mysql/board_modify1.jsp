...
<div class="con_txt">
	<form action="./modify_ok.mysql" method="post" name="frm">
		...
		<div class="contents_sub">	
			...
			<div class="board_write">
				...
				<tr>
					<th>이메일</th>
					<td colspan="3"><input type="text" name="mail1" value="<%=mail %>" class="board_view_input_mail"/> @ <input type="text" name="mail2" value="<%=mail %>" class="board_view_input_mail"/></td>
				</tr>
				</table>
			</div>
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<button type="button" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./view.mysql?seq=<%=seq %>'">보기</button>
				</div>
