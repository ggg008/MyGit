...
<head>
    ...
    <title>MAS Charts Views</title>
    <!-- Custom CSS -->
    <link href="assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
     
    <link href="dist/css/masstyle.css" rel="stylesheet">
...
%>      
                        ...
                        <li id="login-form" class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-wallet m-r-5 m-l-5"></i> Change Name</a>
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-email m-r-5 m-l-5"></i> Change Password</a>
                                <!-- 
                                <div class="dropdown-divider"></div>
...
<% } %>
        ...
        <!-- End Topbar header -->
        <!-- ============================================================== -->
        <aside class="left-sidebarNeo" data-sidebarbg="skin5">
        <!-- Sidebar scroll-->
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link sidebartogglerChart waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu"></span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-dark sidebar-link" href="./authentication-login.jsp" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu"></span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-dark sidebar-link" href="./authentication-register.html" aria-expanded="false"><i class="mdi mdi-all-inclusive"></i><span class="hide-menu"></span></a></li>                        
                        <li class="sidebar-item"> <a class="sidebar-link sidebartogglerCommunity waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-face"></i><span class="hide-menu"></span></a></li>                        
                        <li class="sidebar-item"> <a class="sidebar-link sidebartogglerTheme waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu"></span></a></li>
                                                
                        <!-- 
                         -->
                         
                        <!-- 
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="widgets.html" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu"></span></a></li>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin5">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <!--                     
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="index.html" aria-expanded="false"><i class="mdi mdi-view-dashboard hide-menu"></i><span class="hide-menu"></span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="charts.html" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu"></span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="widgets.html" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu"></span></a></li>
                       
                    </ul>
                     -->
                     
                	<div class="sidebarContents" id="sidebarContents1">
                    	<h3> 1번 컨텐츠 </h3>	                	
                    </div>
                     
                    
                	<div class="sidebarContents" id="sidebarContentsTheme">
                    	<h3> 테마변경 </h3>	                	
                    </div>
                    
                	<div class="sidebarContents" id="sidebarContentsChart">
                    	<h3> 차트 리스트</h3>	                	
                    </div>
                     
                	<div class="sidebarContents" id="sidebarContentsCommunity">
                    	<!-- column -->
                        <div class="card" style="background-color:#1F262D; color:#dbeeff"  >
                            <div class="card-body">
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Main Assets</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="./index.jsp">RESET</a></li>
                                    <!--
				...
				<div class="row">
					...
					<a href="#">
						<div class="card card-hover">
							<div class="box text-center" style="background-color: #9A2EFE">
								<h1 class="font-light text-white">
									<img class="list-icon-bitcoin" src="assets/images/bitcoin.png" height="50"></img>
								</h1>
								<h6 class="text-white">BTC (USD)</h6>
							</div>
						</div>
					</a>
					</div>
					<!-- Column -->
					<div class="col-md-6 col-lg-2 col-xlg-3">
					<a class="testing" href="javascript:void(0)" aria-expanded="false">
						<!-- 
						<a class="testing" href="javascript:void(0)" aria-expanded="false">
						 -->
						<div class="card card-hover">
							<div class="box text-center" style="background-color: #27a9e3">
								<h1 class="font-light text-white">
									<img class="list-icon-bitcoin" src="assets/images/ethereum.png" height="50"></img>									
								</h1>
								<h6 class="text-white">ETH (USD)</h6>
							</div>
						</div>
						<!-- 
						</a>
					...
					<a href="#">
						<div class="card card-hover">
							<div class="box text-center" style="background-color: #da542e">
								<h1 class="font-light text-white">
									<img class="list-icon-bitcoin" src="assets/images/gold.png" height="50"></img>
								</h1>
								<h6 class="text-white">GOLD (USD)</h6>
							</div>
						</div>
					</a>
					</div>
					...
					<a href="#">
						<div class="card card-hover">
							<div class="box text-center" style="background-color:#343a40">
								<h1 class="font-light text-white" >
									<img class="list-icon-bitcoin" src="assets/images/OIL_BARREL-512.png" height="50"></img>
								</h1>
								<h6 class="text-white">WTI (USD)</h6>
							</div>
						</div>
					</a>
					</div>
					...
					<a href="#">
						<div class="card card-hover">
							<div class="box text-center" style="background-color: #28b779!important">
								<h1 class="font-light text-white">
									<img class="list-icon-bitcoin" src="assets/images/southkoreaflag.png" height="50"></img>
								</h1>
								<h6 class="text-white">KOSPI200 (KRW)</h6>
							</div>
						</div>
					</a>
					</div>
					...
					<a href="#">
						<div class="card card-hover">
							<div class="box text-center" style="background-color: #ffb848">
								<h1 class="font-light text-white">
									<img class="list-icon-bitcoin" src="assets/images/nasdaq.png" height="50"></img>
								</h1>
								<h6 class="text-white">NASDAQ (USD)</h6>
							</div>
						</div>
					</a>
					</div>
                                    ...
                                    <div class="col-lg-1">
                                        ...
                                        <!-- 
                                            ...
                                            <a class="testing" href="javascript:void(0)">
                                                <div class="bg-dark p-10 text-white text-center card-hover">
                                            ...
                                            <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center card-hover">
                                                   ...
                                                   <small class="font-light">View Users</small>
                                                </div>
                                            </div>
                                             -->
                                            <div class="col-12 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center card-hover">
                                                   ...
                                                   <small class="font-light">Price</small>
                                                </div>
                                            </div>
                                             <div class="col-12 m-t-15">
                                            	<a class="testing" href="javascript:void(1)">
	                                                <div class="bg-dark p-10 text-white text-center card-hover">
	                                                   <i class="fa fa-tag m-b-5 font-16"></i>
	                                                   <h5 class="m-b-0 m-t-5">9540</h5>
	                                                   <small class="font-light">Volume</small>
	                                                </div>
                                                </a>
                                            </div>
                                            <div class="col-12 m-t-15">
                                            	<a class="testing" href="javascript:void('Change')">
	                                                <div class="bg-dark p-10 text-white text-center card-hover">
	                                                   <i class="fa fa-table m-b-5 font-16"></i>
	                                                   <h5 class="m-b-0 m-t-5">100</h5>
	                                                   <small class="font-light">Change</small>
	                                                </div>
                                                </a>
                                            </div>
                                            <div class="col-12 m-t-15">
                                            	<a class="testing" href="javascript:void('Change2')">
	                                                <div class="bg-dark p-10 text-white text-center card-hover">
