...
<body>
	...
	<div class="con_txt">
		<form action="./controller" method="post" name="frm">
			<!-- 페이지 이동 -->
			<input type="hidden" name="action" value="delete_ok"> <input
				...
				<div class="btn_area">
					<div class="align_left">
						<button type="button" class="btn_list btn_txt02"
							...
							onclick="location.href='./controller?action=list'">목록</button>
						<button type="button" class="btn_list btn_txt02"
							style="cursor: pointer;"
							onclick="location.href='./controller?action=view&seq=<%=seq%>'">보기</button>
					</div>
